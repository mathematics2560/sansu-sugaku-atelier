    ...
    prints: [
      {
        id: "01",
        title: "指数の拡張と累乗根",
        desc: "指数を負の整数や有理数まで拡張する考え方や、累乗根の意味、指数法則について学ぶプリントです。",
        filename: "5_指数関数と対数関数_No.1.pdf",
      },
      {
        id: "02",
        title: "指数関数のグラフと性質",
        desc: "指数関数のグラフの特徴や性質、大小比較や方程式・不等式への応用について学ぶプリントです。",
        filename: "5_指数関数と対数関数_No.2.pdf",
      },
      {
        id: "03",
        title: "対数の定義と性質",
        desc: "対数の定義や基本性質、対数の計算、底の変換公式について学ぶプリントです。",
        filename: "5_指数関数と対数関数_No.3.pdf",
      },
      {
        id: "04",
        title: "対数関数のグラフと方程式・不等式",
        desc: "対数関数のグラフの特徴や性質、対数方程式・対数不等式の解き方について学ぶプリントです。",
        filename: "5_指数関数と対数関数_No.4.pdf",
      },
      {
        id: "05",
        title: "常用対数と桁数",
        desc: "常用対数の意味や利用方法、対数を利用した桁数の求め方について学ぶプリントです。",
